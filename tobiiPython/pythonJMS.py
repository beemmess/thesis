...
class MyListener(stomp.ConnectionListener):
    ...
    def on_message(self, headers, message):
        ...
        # conn1.send(body=message, destination='jms.queue.eyetrackerQueue')
...
conn1.subscribe(destination='jms.queue.testQueue', id=1, ack='auto')
...
n=0
conn1.send(body=f1, destination='jms.queue.testQueue')
